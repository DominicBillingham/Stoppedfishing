...
namespace StoppedFishing.Migrations
{
    ...
    [Migration("20230801174526_AddedTimeBlocks")]
    partial class AddedTimeBlocks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AspNetCore.Data.Models.User", b =>
                {
                    ...
                    b.OwnsMany("AspNetCore.Data.Models.SimpleTimeBlock", "TimeBlock", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
